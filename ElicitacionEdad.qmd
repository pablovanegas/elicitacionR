...
'Muy poco probable' 0 \< x \< 10 \Corregir
'Poco probable' 10 \< x \< 20 'No estoy seguro' 20 \< x \< 30 'Es posible' 30 \< x \< 40 'Es muy posible' 40 \< x \< 50
...
# Corregir altura (ubicacion) de etiquetas en el eje Y
```{r}
par(lab=c(30,20,20))
par(yaxt='n')
...
legend(15.1,5,'Seguro que no',cex=0.5,bg='white')
legend(15.1,15,'Poco probable',cex=0.5,bg='white')
legend(15.1,25,'Puede ser',cex=0.5,bg='white')
legend(15.1,35,'Casi seguro',cex=0.5,bg='white')
legend(15.1,45,'Estoy seguro',cex=0.5,bg='white')
